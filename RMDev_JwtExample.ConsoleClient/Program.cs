...
namespace RMDev_JwtExample.ConsoleClient
{
    public class Token
    {
    ...
    class Program
    {
        ...
        {
            //Nota: Inicialmente é necessário executar o projeto `RMDev_JwtExample` para então executar o projeto `ConsoleClient`.

            var baseAddress = "http://localhost:9577/";
            var token = LoginAsync(baseAddress: baseAddress, username: "Ricardo", password: "1234").GetAwaiter().GetResult();
